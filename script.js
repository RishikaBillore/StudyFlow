...
//         // Initialization of the StudyPlanner after authentication
...
//             const formElement = activeForm.querySelector('form');
//             if (formElement) {
//                 activeForm.insertBefore(errorDiv, formElement);
//             }
//         }
//     }
...
//             const formElement = activeForm.querySelector('form');
//             if (formElement) {
//                 activeForm.insertBefore(successDiv, formElement);
//             }
//         }
//     }
...
// class StudyPlanner {
//     constructor() {
//         // initializing only if user is authenticated
...
//             isRunning: false,
//             isPaused: false,
//             timeLeft: 25 * 60, // 25 minutes in seconds conversion
//             isBreak: false,
//             workDuration: 25,
//             breakDuration: 5
//         };
...
//     // Get a particular user's storage key
...
//         localStorage.setItem('studyPlanner_theme', newTheme);
...
//                  onclick="window.studyPlanner.showTaskDetails('${task.id}')">
...
//                                 onclick="window.studyPlanner.toggleTask('${task.id}')"
//                                 title="${task.completed ? 'Mark as incomplete' : 'Mark as complete'}">
//                             ${task.completed ? '↻' : '✓'}
//                         </button>
//                         ${!task.completed ? `
//                             <button class="btn btn-small btn-warning"
//                                     onclick="window.studyPlanner.startPomodoro('${task.id}')"
//                                     title="Start Pomodoro">
//                                 ⏲️
//                             </button>
//                         ` : ''}
//                         <button class="btn btn-small"
//                                 onclick="window.studyPlanner.editTask('${task.id}')"
//                                 title="Edit task">
//                             ✎
//                         </button>
//                         <button class="btn btn-small btn-danger"
//                                 onclick="window.studyPlanner.deleteTask('${task.id}')"
//                                 title="Delete task">
//                             🗑️
//                         </button>
//                     </div>
...
//                             onclick="window.studyPlanner.toggleTask('${task.id}'); window.studyPlanner.closeTaskModal();">
//                         ${task.completed ? 'Mark as Incomplete' : 'Mark as Complete'}
//                     </button>
//                     ${!task.completed ? `
//                         <button class="btn btn-warning" onclick="window.studyPlanner.startPomodoro('${task.id}'); window.studyPlanner.closeTaskModal();">
//                             Start Pomodoro Timer
//                         </button>
//                     ` : ''}
//                     <button class="btn" onclick="window.studyPlanner.editTask('${task.id}'); window.studyPlanner.closeTaskModal();">
//                         Edit Task
//                     </button>
//                     <button class="btn btn-danger" onclick="window.studyPlanner.deleteTask('${task.id}'); window.studyPlanner.closeTaskModal();">
//                         Delete Task
//                     </button>
//                 </div>
//             </div>
...
//             const daysDiff = (lastDate - taskDate) / (1000 * 60 * 60 * 24);
...
//     // Clear All Data Method (User-Specific)
//     clearAllData() {
...
//             if (confirm('🚨 FINAL WARNING: This will delete EVERYTHING!\n\nAll your tasks, progress, and data will be permanently lost.\n\nClick OK to DELETE ALL DATA or Cancel to keep everything.')) {
//                 try {
...
//     // Add remaining StudyPlanner methods (Charts, Timeline, Pomodoro, Notifications, etc.)
//     initializeCharts() {
...
//                             body: `"${updatedTask.title}" is due in ${updatedTask.reminderTime} minutes!`
//                         });
//                     }
//                     this.showToast('Reminder', `"${updatedTask.title}" is due soon!`, 'warning');
//                 }
//             }, timeToReminder);
//         }
//     }
